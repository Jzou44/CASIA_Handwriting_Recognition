...
with tf.Session() as sess:
    ...
    if (config.MODE == tf.estimator.ModeKeys.TRAIN):
        ...
        while True:
            ...
            _, cost, cost_s, cost_e = sess.run([train_op, loss_softmax_plus_euclidean, loss_softmax, loss_euclidean],
                                               feed_dict={X: batch_x, Y: batch_y})
            log.info("batch_round: {0},cost={1},softmax={2},euclidean={3}".format(batch_round, cost, cost_s, cost_e))
